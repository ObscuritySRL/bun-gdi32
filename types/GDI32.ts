...
export type HCOLORSPACE = Pointer;
export type HDC = Pointer;
export type HENHMETAFILE = Pointer;
export type HFONT = Pointer;
export type HGDIOBJ = Pointer;
export type HGLOBAL = Pointer;
export type HGLRC = Pointer;
export type HMETAFILE = Pointer;
export type HPALETTE = Pointer;
export type HPEN = Pointer;
